    ...
    return (
        <>
            ...
            <div className="myaccount-row">
                ...
                <div style={{display:"flex", justifyContent:"center", marginLeft:"16px"}}>
                    <input className="myaccount-input" name='pin' type='tel' pattern='[0-9]*' placeholder='0000' onChange={(e)=>{setPinField(e.target.value.substring(0,6) || null)}} value={pinField || ''}/>
